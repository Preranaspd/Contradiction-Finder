...
Contradiction Detection - Identifies core conflicts
...
├── requirements.txt
└── run.py
Browser → Flask Routes → LangChain LCEL Chains → Gemma AI
   ↓              ↓                ↓              ↓
HTML/JS      /api/analyze     Prompt|LLM|Parser   gemma-3-12b-it
